...
INSERT INTO chore(name, regularity, deadline, completed, party_id, user_id) VALUES ('Legge inn testdata',0,'29-01-18', 0, 1, 'en@h.no');
INSERT INTO chore(name, regularity, deadline, completed, party_id, user_id) VALUES ('Legge inn testdata igjen',0,'02-02-18', 0, 1, 'to@h.no');
INSERT INTO chore(name, regularity, deadline, completed, party_id, user_id) VALUES ('Kjedelig å legge inn testdata',0,'10-02-18', 0, 1, 'tre@h.no');
INSERT INTO chore(name, regularity, deadline, completed, party_id, user_id) VALUES ('Male vinduet',0,'12-03-18', 0, 1, NULL);
INSERT INTO chore(name, regularity, deadline, completed, party_id, user_id) VALUES ('Tømme badekaret',0,'29-08-18', 0, 1, NULL);
